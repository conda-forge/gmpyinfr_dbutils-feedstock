About gmpyinfr_dbutils-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gmpyinfr_dbutils-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12316&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gmpyinfr_dbutils-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gmpyinfr_dbutils` can be installed with `conda`:
...
```
mamba install gmpyinfr_dbutils
```

It is possible to list all of the versions of `gmpyinfr_dbutils` available on your platform with `conda`:
...
```
mamba search gmpyinfr_dbutils --channel conda-forge
```
...
mamba repoquery search gmpyinfr_dbutils --channel conda-forge

# List packages depending on `gmpyinfr_dbutils`:
mamba repoquery whoneeds gmpyinfr_dbutils --channel conda-forge

# List dependencies of `gmpyinfr_dbutils`:
mamba repoquery depends gmpyinfr_dbutils --channel conda-forge
```
